...
function lockPage() {
    layer.open({
        ...
        '<source src="/cyui/statics/login/login.mp4" type="video/mp4"> </video>' +
        '<div class="lock-content"><div class="admin-header-lock" id="lock-box">'+
        '<div class="admin-header-lock-img"><img src="/cyui/statics/images/index/head.jpg"/></div>'+
...
$(document).ready(function () {
    //默认显示菜单
    createMenu("/cyui/statics/json/layuiMenu.json");
    setMainHeight();
});
